                        ...
                        <table className="w-full text-sm">
                            <thead className="bg-slate-50 sticky top-0 z-10">
                                <tr>
                                    ...
                                    <th className="text-left px-4 py-2.5 font-semibold text-slate-500 text-xs uppercase tracking-wider w-[60px]">ROI</th>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {tickets.map((t) => (
                                    <tr key={t.jira_key} className="hover:bg-slate-50/60 transition-colors">
                                        ...
                                        <td className="px-4 py-2.5 text-slate-700 max-w-[300px] truncate">{t.summary}</td>
                                        <td className="px-4 py-2.5">
                                            <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${getStatusColor(t.status_category)}`}>
                                                {t.status}
                                            </span>
                                        </td>
                                        <td className="px-4 py-2.5 text-slate-600 font-medium text-xs">
                                            {t.roi_score !== null ? t.roi_score : '—'}
                                        </td>
                                        <td className="px-4 py-2.5">
