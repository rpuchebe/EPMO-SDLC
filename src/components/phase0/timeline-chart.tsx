...
function aggregateByGranularity(
    ...
    for (const d of data) {
        ...
        // All workstreams total
        allMap[key] = (allMap[key] || 0) + d.ticket_count

        // If this row matches the selected workstream
...
export function TimelineChart({ data, selectedWorkstream }: TimelineChartProps) {
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">Tickets created over time</p>
                </div>
