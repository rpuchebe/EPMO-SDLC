...
(1, 'Foundation & Framework Design', 'Core design and process setup', '2026-01-01', '2026-02-15', 'completed', 100, 20),
(2, 'Wave 1 – Pilot (MAPS, EG)', 'Initial rollout to pilot workstreams', '2026-02-16', '2026-03-31', 'in_progress', 50, 20),
(3, 'Wave 2 – Expansion (PCE, Banking & Treasury, Global Markets)', 'Expansion to additional large units', '2026-04-01', '2026-05-31', 'pending', 0, 30),
(4, 'Wave 3 – Enterprise Completion', 'Remaining enterprise workstreams', '2026-06-01', '2026-07-31', 'pending', 0, 20),
(5, 'Institutionalization / Project Complete', 'Final wrap up and knowledge transfer', '2026-08-01', '2026-08-31', 'pending', 0, 10);
